...
public class VersionRange implements Serializable {
     ...
     *                        lower boundary (not left bounded).
     * @param minimumIncluded specifies whether the minimum version is included in
     *                        the range (whether it is left closed). This value is
     *                        not allowed to be true in case of no lower boundary.
     * @param maximum         is the maximum {@link Version} of this version range.
     *                        This version may be null to signal that there is no
     *                        upper boundary (not right bounded).
     * @param maximumIncluded specifies whether the maximum version is included in
     *                        the range (whether it is right closed). This value is
     *                        not allowed to be true in case of no upper boundary.
     */
    public VersionRange(Version minimum, boolean minimumIncluded, Version maximum, boolean maximumIncluded) {
	super();
	if (minimum != null) {
    ...
    /**
     * Returns whether the minimum version is included in the range (left closed).
     *
     * @return <code>true</code> is returned in case the minimum version is included
     *         e.g. the range is left closed.
     */
    ...
    /**
     * Returns whether the maximum version is included in the range (right closed).
     *
     * @return <code>true</code> is returned in case the maximum version is included
     *         e.g. the range is right closed.
     */
     ...
     *
     * @param version is the {@link Version} to be tested agains this range.
